...
def render_frame(A: float, B: float) -> np.array:
    def pprint(array: np.ndarray) -> None:
        """ Pretty print the frame."""
        """
        Returns a frame of the spinning 3D dougnut.
        Based on the pseudocode from:https//www.a1k0n.net/2022/07/20/donut-math.html 
        """
    ...
    yp = (screen_size / 2 + K1 * ooz * x).astype(int)  # (90, 315)
