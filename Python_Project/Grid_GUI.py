...
def new_window():
    ...
    user = Label(new, text="User Name :", cursor="dot").grid(row=5, column=0)
...
txtF_name = Entry(font=fontStyle_2, bd=4, width=15)
l_name = Label(text="Last Name:", font=fontStyle_2)
txtl_name = Entry(font=fontStyle_2, bd=4, width=15)
Uname = Label(text="User Name:", font=fontStyle_2)
txtU_name = Entry(font=fontStyle_2, bd=4, width=15)
Pass = Label(text="Password:", font=fontStyle_2)
txtPass = Entry(font=fontStyle_2, bd=4, width=15)
btsign = Button(command=validate, text="Sign In", bd=4, font=fontStyle_2)
btcancle = Button(command=CloseWindow, text="Close", bd=4, font=fontStyle_2)
radmale = Radiobutton(text="Male", value="Male", bd=4, variable=gen)
radfemale = Radiobutton(text="Female", value="Female", bd=4, variable=gen)
terms = Checkbutton(text="Agree to our Terms and Policies", fg="Blue", variable=term)
